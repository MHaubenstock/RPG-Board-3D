final var centerScreen : Vector2 = Vector2(Screen.width / 2, Screen.height / 2);
...
private var thisAction : boolean = false;
		...
		if(Physics.Raycast(ray, hit, 100))
		{
			...
			else
			{
				...
				*/
				...
				{
					if(selectedPiece && selectedPiece.GetComponent(WorldObject) && selecting)
						selectedPiece.GetComponent(WorldObject).defaultAction();
